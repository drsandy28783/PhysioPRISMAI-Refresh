...
def sitemap():
    ...
    try:
        ...
        static_pages = [
            ...
            {'url': '/for-clinics', 'priority': '0.8', 'changefreq': 'monthly'},
            {'url': '/for-universities', 'priority': '0.8', 'changefreq': 'monthly'},
            {'url': '/for-researchers', 'priority': '0.7', 'changefreq': 'monthly'},
            {'url': '/reviews', 'priority': '0.7', 'changefreq': 'monthly'},
            {'url': '/free-trial', 'priority': '0.8', 'changefreq': 'monthly'},
            {'url': '/scheduling-info', 'priority': '0.5', 'changefreq': 'monthly'},
